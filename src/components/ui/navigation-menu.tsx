...
const NavigationArrow = () => {
    ...
    return (
        <motion.div
            ...
            className='fixed z-[100]  bg-primary-color animate-bounce bottom-16 top-auto right-8 rounded-full size-10 lg:size-14 flex items-center justify-center shadow-sm overflow-hidden'
